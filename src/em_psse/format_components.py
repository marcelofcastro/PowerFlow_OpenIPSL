...
def format_gen(df):
	...
	df = df.rename(index=str,columns={'I':'bus','PT':'p_max','PG':'p_gen','PB':'p_min','QG':'q_gen','QT':'q_max','QB':'q_min','STAT':'status','ID':'circuit'})
	return df[['bus','p_max','p_gen','p_min','q_gen','q_max','q_min','status','circuit']]
